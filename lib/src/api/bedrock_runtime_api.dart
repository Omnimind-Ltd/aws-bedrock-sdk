...
class BedrockRuntime {
  ...
  Future<ConverseStreamResponse> converseStream({
    ...
    final $json = await jsonFromResponse(response);
    return ConverseStreamResponse(stream: ConverseStreamOutput.fromJson($json));
  }
  ...
  Future<InvokeModelResponse> invokeModel({
    ...
    return InvokeModelResponse(
      ...
      contentType: extractHeaderStringValue(response.headers, 'Content-Type')!,
    );
  }
...
class ApplyGuardrailResponse {
  ...
  factory ApplyGuardrailResponse.fromJson(Map<String, dynamic> json) {
    return ApplyGuardrailResponse(
      ...
      assessments:
          (json['assessments'] as List).nonNulls
              .map(
                (e) => GuardrailAssessment.fromJson(e as Map<String, dynamic>),
              )
              .toList(),
      outputs:
          (json['outputs'] as List).nonNulls
              .map(
                (e) =>
                    GuardrailOutputContent.fromJson(e as Map<String, dynamic>),
              )
              .toList(),
...
class ContentBlock {
  ...
  factory ContentBlock.fromJson(Map<String, dynamic> json) {
    return ContentBlock(
      ...
      toolResult:
          json['toolResult'] != null
              ? ToolResultBlock.fromJson(
...
class ContentBlockDelta {
  ...
  ContentBlockDelta({this.text, this.toolUse});
...
class ContentBlockStopEvent {
  ...
  ContentBlockStopEvent({required this.contentBlockIndex});
...
enum ConversationRole {
  ...
  static ConversationRole fromString(String value) => values.firstWhere(
    (e) => e.value == value,
    orElse:
...
class ConverseMetrics {
  ...
  ConverseMetrics({required this.latencyMs});

  factory ConverseMetrics.fromJson(Map<String, dynamic> json) {
    return ConverseMetrics(latencyMs: json['latencyMs'] as int);
  }
}
...
class ConverseStreamMetadataEvent {
  ...
  factory ConverseStreamMetadataEvent.fromJson(Map<String, dynamic> json) {
    return ConverseStreamMetadataEvent(
      ...
      trace:
          json['trace'] != null
              ? ConverseStreamTrace.fromJson(
                json['trace'] as Map<String, dynamic>,
              )
              : null,
    );
  }
...
class ConverseStreamMetrics {
  ...
  ConverseStreamMetrics({required this.latencyMs});

  factory ConverseStreamMetrics.fromJson(Map<String, dynamic> json) {
    return ConverseStreamMetrics(latencyMs: json['latencyMs'] as int);
  }
}
...
class ConverseStreamResponse {
  ...
  ConverseStreamResponse({this.stream});
}
...
class ConverseStreamTrace {
  ...
  ConverseStreamTrace({this.guardrail});
...
class DocumentBlock {
  ...
  Map<String, dynamic> toJson() {
    ...
    return {'format': format.value, 'name': name, 'source': source};
  }
}
...
enum DocumentFormat {
  ...
  static DocumentFormat fromString(String value) => values.firstWhere(
    (e) => e.value == value,
    orElse: () => throw Exception('$value is not known in enum DocumentFormat'),
  );
}
...
class DocumentSource {
  ...
  DocumentSource({this.bytes});

  factory DocumentSource.fromJson(Map<String, dynamic> json) {
    return DocumentSource(
      bytes: decodeNullableUint8List(json['bytes'] as String?),
    );
  }

  Map<String, dynamic> toJson() {
    final bytes = this.bytes;
    return {if (bytes != null) 'bytes': base64Encode(bytes)};
  }
}
...
enum GuardrailAction {
  ...
  static GuardrailAction fromString(String value) => values.firstWhere(
    (e) => e.value == value,
    orElse:
...
class GuardrailContentBlock {
  ...
  GuardrailContentBlock({this.text});
...
enum GuardrailContentFilterConfidence {
  ...
  static GuardrailContentFilterConfidence fromString(
    String value,
  ) => values.firstWhere(
    (e) => e.value == value,
    orElse:
...
class GuardrailContentPolicyAssessment {
  ...
  GuardrailContentPolicyAssessment({required this.filters});

  factory GuardrailContentPolicyAssessment.fromJson(Map<String, dynamic> json) {
    return GuardrailContentPolicyAssessment(
      filters:
          (json['filters'] as List).nonNulls
              .map(
                (e) =>
                    GuardrailContentFilter.fromJson(e as Map<String, dynamic>),
              )
              .toList(),
    );
  }
...
enum GuardrailContentSource {
  ...
  static GuardrailContentSource fromString(String value) => values.firstWhere(
    (e) => e.value == value,
    orElse:
        () =>
            throw Exception(
...
enum GuardrailContextualGroundingFilterType {
  ...
  static GuardrailContextualGroundingFilterType fromString(
    String value,
  ) => values.firstWhere(
    (e) => e.value == value,
    orElse:
...
enum GuardrailContextualGroundingPolicyAction {
  ...
  static GuardrailContextualGroundingPolicyAction fromString(
    String value,
  ) => values.firstWhere(
    (e) => e.value == value,
    orElse:
...
class GuardrailContextualGroundingPolicyAssessment {
  ...
  GuardrailContextualGroundingPolicyAssessment({this.filters});
  ...
  factory GuardrailContextualGroundingPolicyAssessment.fromJson(
    ...
    return GuardrailContextualGroundingPolicyAssessment(
      filters:
          (json['filters'] as List?)?.nonNulls
              .map(
                (e) => GuardrailContextualGroundingFilter.fromJson(
...
class GuardrailConverseContentBlock {
  ...
  GuardrailConverseContentBlock({this.text});
...
enum GuardrailConverseContentQualifier {
  ...
  static GuardrailConverseContentQualifier fromString(
    String value,
  ) => values.firstWhere(
    (e) => e.value == value,
    orElse:
...
class GuardrailCustomWord {
  ...
  GuardrailCustomWord({required this.action, required this.match});
...
enum GuardrailManagedWordType {
  ...
  static GuardrailManagedWordType fromString(String value) => values.firstWhere(
    (e) => e.value == value,
    orElse:
        () =>
            throw Exception(
...
class GuardrailOutputContent {
  ...
  GuardrailOutputContent({this.text});

  factory GuardrailOutputContent.fromJson(Map<String, dynamic> json) {
    return GuardrailOutputContent(text: json['text'] as String?);
  }
}
...
enum GuardrailPiiEntityType {
  ...
  static GuardrailPiiEntityType fromString(String value) => values.firstWhere(
    (e) => e.value == value,
    orElse:
        () =>
            throw Exception(
...
enum GuardrailSensitiveInformationPolicyAction {
  ...
  static GuardrailSensitiveInformationPolicyAction fromString(
    String value,
  ) => values.firstWhere(
    (e) => e.value == value,
    orElse:
...
class GuardrailSensitiveInformationPolicyAssessment {
  ...
  factory GuardrailSensitiveInformationPolicyAssessment.fromJson(
    ...
    return GuardrailSensitiveInformationPolicyAssessment(
      piiEntities:
          (json['piiEntities'] as List).nonNulls
              .map(
                (e) => GuardrailPiiEntityFilter.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList(),
      regexes:
          (json['regexes'] as List).nonNulls
              .map(
                (e) => GuardrailRegexFilter.fromJson(e as Map<String, dynamic>),
              )
              .toList(),
    );
  }
...
class GuardrailTextBlock {
  ...
  GuardrailTextBlock({required this.text, this.qualifiers});
...
enum GuardrailTrace {
  ...
  static GuardrailTrace fromString(String value) => values.firstWhere(
    (e) => e.value == value,
    orElse: () => throw Exception('$value is not known in enum GuardrailTrace'),
  );
}
...
class GuardrailTraceAssessment {
  ...
  factory GuardrailTraceAssessment.fromJson(Map<String, dynamic> json) {
    return GuardrailTraceAssessment(
      ...
      modelOutput:
          (json['modelOutput'] as List?)?.nonNulls
              .map((e) => e as String)
              .toList(),
...
class GuardrailWordPolicyAssessment {
  ...
  factory GuardrailWordPolicyAssessment.fromJson(Map<String, dynamic> json) {
    return GuardrailWordPolicyAssessment(
      customWords:
          (json['customWords'] as List).nonNulls
              .map(
                (e) => GuardrailCustomWord.fromJson(e as Map<String, dynamic>),
              )
              .toList(),
      managedWordLists:
          (json['managedWordLists'] as List).nonNulls
              .map(
                (e) => GuardrailManagedWord.fromJson(e as Map<String, dynamic>),
              )
              .toList(),
    );
  }
...
class ImageBlock {
  ...
  ImageBlock({required this.format, required this.source});
  ...
  Map<String, dynamic> toJson() {
    final format = this.format;
    final source = this.source;
    return {'format': format.value, 'source': source};
  }
}
...
/// An internal server error occurred. Retry your request.
class InternalServerException implements AwsException {
  final String? message;

  InternalServerException({this.message});

  factory InternalServerException.fromJson(Map<String, dynamic> json) {
    return InternalServerException(message: json['message'] as String?);
  }
}
...
class InvokeModelResponse {
  ...
  InvokeModelResponse({required this.body, required this.contentType});
}
...
class MessageStartEvent {
  ...
  MessageStartEvent({required this.role});
...
class ModelStreamErrorException implements AwsException {
  final String? message;
...
/// timeout length.
class ModelTimeoutException implements AwsException {
  final String? message;

  ModelTimeoutException({this.message});

  factory ModelTimeoutException.fromJson(Map<String, dynamic> json) {
    return ModelTimeoutException(message: json['message'] as String?);
  }
}
  ...
  factory ResponseStream.fromJson(Map<String, dynamic> json) {
    return ResponseStream(
      ...
      modelTimeoutException:
          json['modelTimeoutException'] != null
...
/// The service isn't currently available. Try again later.
class ServiceUnavailableException implements AwsException {
  final String? message;

  ServiceUnavailableException({this.message});

  factory ServiceUnavailableException.fromJson(Map<String, dynamic> json) {
    return ServiceUnavailableException(message: json['message'] as String?);
  }
}
...
class SpecificToolChoice {
  ...
  SpecificToolChoice({required this.name});
...
class SystemContentBlock {
  ...
  SystemContentBlock({this.guardContent, this.text});
...
/// href="https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html">Provisioned
/// Throughput</a> to increase the rate or number of tokens you can process.
class ThrottlingException implements AwsException {
  final String? message;

  ThrottlingException({this.message});

  factory ThrottlingException.fromJson(Map<String, dynamic> json) {
    return ThrottlingException(message: json['message'] as String?);
  }
}
...
class Tool {
  ...
  Map<String, dynamic> toJson() {
    ...
    return {if (toolSpec != null) 'toolSpec': toolSpec};
  }
}
...
class ToolChoice {
  ...
  ToolChoice({this.any, this.auto, this.tool});
...
class ToolConfiguration {
  ...
  ToolConfiguration({required this.tools, this.toolChoice});

  Map<String, dynamic> toJson() {
    final tools = this.tools;
    final toolChoice = this.toolChoice;
    return {'tools': tools, if (toolChoice != null) 'toolChoice': toolChoice};
  }
}
...
class ToolInputSchema {
  ...
  ToolInputSchema({this.json});

  Map<String, dynamic> toJson() {
    final json = this.json;
    return {if (json != null) 'json': json};
  }
}
    ...
    return ToolResultBlock(
      content:
          (json['content'] as List).nonNulls
              .map(
                (e) =>
                    ToolResultContentBlock.fromJson(e as Map<String, dynamic>),
              )
              .toList(),
...
class ToolResultContentBlock {
  ...
  ToolResultContentBlock({this.document, this.image, this.json, this.text});
...
enum ToolResultStatus {
  ...
  static ToolResultStatus fromString(String value) => values.firstWhere(
    (e) => e.value == value,
    orElse:
...
class ToolUseBlock {
  ...
  Map<String, dynamic> toJson() {
    ...
    final name = this.name;
    final toolUseId = this.toolUseId;
    return {'input': input, 'name': name, 'toolUseId': toolUseId};
  }
}
...
class ToolUseBlockDelta {
  ...
  ToolUseBlockDelta({required this.input});

  factory ToolUseBlockDelta.fromJson(Map<String, dynamic> json) {
    return ToolUseBlockDelta(input: json['input'] as String);
  }
}
...
class ToolUseBlockStart {
  ...
  ToolUseBlockStart({required this.name, required this.toolUseId});
...
enum Trace {
  ...
  static Trace fromString(String value) => values.firstWhere(
    (e) => e.value == value,
...
/// Input validation failed. Check your request parameters and retry the
/// request.
class ValidationException implements AwsException {
  final String? message;

  ValidationException({this.message});

  factory ValidationException.fromJson(Map<String, dynamic> json) {
    return ValidationException(message: json['message'] as String?);
  }
}

class AccessDeniedException extends GenericAwsException {
  AccessDeniedException({super.type, super.message})
    : super(code: 'AccessDeniedException');
}

class ModelErrorException extends GenericAwsException {
  ModelErrorException({super.type, super.message})
    : super(code: 'ModelErrorException');
}

class ModelNotReadyException extends GenericAwsException {
  ModelNotReadyException({super.type, super.message})
    : super(code: 'ModelNotReadyException');
}

class ResourceNotFoundException extends GenericAwsException {
  ResourceNotFoundException({super.type, super.message})
    : super(code: 'ResourceNotFoundException');
}

class ServiceQuotaExceededException extends GenericAwsException {
  ServiceQuotaExceededException({super.type, super.message})
    : super(code: 'ServiceQuotaExceededException');
}

final _exceptionFns = <String, AwsExceptionFn>{
  'AccessDeniedException':
      (type, message) => AccessDeniedException(type: type, message: message),
  'InternalServerException':
      (type, message) => InternalServerException(message: message),
  'ModelErrorException':
      (type, message) => ModelErrorException(type: type, message: message),
  'ModelNotReadyException':
      (type, message) => ModelNotReadyException(type: type, message: message),
  'ModelStreamErrorException':
      (type, message) => ModelStreamErrorException(message: message),
  'ModelTimeoutException':
      (type, message) => ModelTimeoutException(message: message),
  ...
  'ServiceUnavailableException':
      (type, message) => ServiceUnavailableException(message: message),
  'ThrottlingException':
      (type, message) => ThrottlingException(message: message),
  'ValidationException':
      (type, message) => ValidationException(message: message),
};
